...
# ===== BUBBLE CHART OF GROUPED SHOTS =====

import plotly.express as px
grouped_shots_df = pd.read_csv('basketball_plots/srcdata/league_shots_by_dist.csv')
...
# Bubble chart with added column of expected points
grouped_shots_df = grouped_shots_df.assign(expected_points=grouped_shots_df.shots_accuracy * 2)
...
import pickle
with open('basketball_plots/srcdata/league_hexbin_stats.pickle', 'rb') as f:
...
# pio.write_html(fig, file='temp/basketball_plots_' + teamname.lower() + '_shotchart.html', auto_open=False, include_plotlyjs='cdn', config=dict(displayModeBar=False))
